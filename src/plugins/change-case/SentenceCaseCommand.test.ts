...
describe('SentanceCaseCommand', () => {
  ...
  it('should handle execute and return true', () => {
    expect(
      plugin.execute(state, () => {}, {} as unknown as EditorView)
    ).toBeTruthy();
  });
  ...
  it('should handle executeCustom and return tr', () => {
    expect(
      plugin.executeCustom(state, {} as unknown as Transform)
    ).toStrictEqual({});
  });
  ...
  it('should handle parseSelectedText when text has .', () => {
    expect(
      plugin.parseSelectedText('What is a text? This is a text.')
    ).toBeDefined();
  });
  it('should handle parseSelectedText when text has .', () => {
    expect(
