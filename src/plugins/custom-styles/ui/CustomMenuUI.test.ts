...
describe('Custom Menu UI', () => {
  ...
  it('should update the style search term', () => {
    const previousSelectedIndex = custommenuui._selectedIndex;
    const spy = jest
    ...
    custommenuui.state = { ...custommenuui.state, searchTerm: '' };
    custommenuui._selectedIndex = previousSelectedIndex;
    spy.mockRestore();
  });
