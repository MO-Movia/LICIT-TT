...
describe('CustomStyleCommand', () => {
          ...
          parseDOM: [
            {
              ...
              getAttrs(dom) {
                return {
                  styleName: (dom).getAttribute('style-name'),
                };
              },
            },
          ],
          ...
          content: [
            {
              ...
              marks: [
                ...
                {
                  type: 'link',
                  attrs: { href: 'https://example.com', overridden: false },
                }, // Condition 4: A link mark
              ],
            },
            {
              type: 'text',
  ...
  it('should handle resetNumber', () => {
    expect(
      customstylecommand.resetNumber(
        {
          tr: {
            setNodeMarkup: () => {
              return {};
...
describe('removeAllMarksExceptLink', () => {
  ...
  it('removes all marks except link for tables and override', () => {
    ...
    expect(
      removeAllMarksExceptLinkForTableColumnCell(0, node, tr)
    ).toBeDefined();
  });
...
describe('applyStyleToEachNode', () => {
  ...
  it('applies style using positions array', () => {
    ...
    const result = applyStyleToEachNode(
      state,
      0,
      tr.doc.nodeSize - 2,
      tr,
  ...
  it('apply customStyle for table', () => {
    ...
    expect(
      applyStyleForTableColumnCell(mockval, 'stylename', state, tr, node, 0)
    ).toBeDefined();
  });
