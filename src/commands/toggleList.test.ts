...
describe('toggleList', () => {
  ...
  describe('wrapItemsWithListInternal', () => {
    const items = [
      {
        node: { id: 1, name: 'Node 1', marks: 'fg' } as unknown as Node,
        pos: 2,
      },
    ];
...
describe('wrapNodesWithListInternal', () => {
  it('should handle wrapNodesWithListInternal', () => {
    ...
    expect(
      wrapNodesWithListInternal(memo, null as unknown as NodeType, 'test')
    ).toBeDefined();
  });
});
...
describe('wrapNodesWithList', () => {
  it('should handle wrapNodesWithList', () => {
    ...
    expect(
      wrapNodesWithList(tr, mySchema, null as unknown as NodeType, 'test')
    ).toBeDefined();
  });
});
...
describe('wrapNodesWithListInternal with nodetype', () => {
    ...
    mockTransaction = {
      doc: {
        nodesBetween: jest.fn((_from, _to, callback) => {
          callback({ type: { name: 'paragraph' }, attrs: {}, marks: [] }, 0);
        }),
      },
      selection: {
        from: 0,
  ...
  it('should handle newselection and modify the range', () => {
    ...
    expect(mockTransaction.doc.nodesBetween).toHaveBeenCalledWith(
      0,
      1,
      expect.any(Function)
    );
