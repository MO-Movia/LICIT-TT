...
// Mock Editor (used by tableDeleteRowCommand)
...
describe('tableDeleteRowCommand', () => {
  ...
  it('should call deleteRow when execute is called', () => {
    // Mock the deleteRow command method
    const deleteRowMock = jest.spyOn(command, 'getEditor').mockReturnValue({
      commands: {
        deleteRow: () => {
          return true;
        },
  ...
  it('should return the result of deleteRow when execute is called', () => {
    // Mock the return value of deleteRow
