...
import tableToggleHeaderRowCommand from './tableToggleHeaderRowCommand';
import { Schema } from '@tiptap/pm/model';

// Mock Editor (used by tableToggleHeaderRowCommand)
...
describe('tableToggleHeaderRowCommand', () => {
  ...
  it('should call toggleHeaderRow when execute is called', () => {
    // Mock the toggleHeaderRow command method
    const toggleHeaderRowMock = jest
    ...
    expect(toggleHeaderRowMock).toHaveBeenCalled();
  });

  it('should return the result of toggleHeaderRow when execute is called', () => {
    // Mock the return value of toggleHeaderRow
