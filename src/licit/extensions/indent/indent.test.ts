...
describe('Indent Extension - Keyboard Shortcuts', () => {
  ...
  beforeEach(() => {
    ...
    shortcuts = editor.extensionManager.extensions
      .find((ext) => ext.name === 'indent')
  ...
  test.each([['Mod-[', 'outdent', false]])(
    'should call %s shortcut to execute %s command',
    (key, command, outdentOnlyAtHead) => {
  ...
  test.each([['Shift-Tab', 'outdent', false]])(
    'should call %s shortcut to execute %s command',
    (key, command, outdentOnlyAtHead) => {
      // Ensure function exists
      expect(shortcuts[key]).toBeDefined();
  ...
  test.each([['Backspace', 'outdent', true]])(
    'should call %s shortcut to execute %s command',
    (key, command, outdentOnlyAtHead) => {
      // Ensure function exists
      expect(shortcuts[key]).toBeDefined();
