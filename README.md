...
|---:|---|---|---|
| 1 | https://github.com/MO-Movia/licit | Editor integrated with TipTap & Licit | Broad refactor across the editor<br>Adopted shared `EditorToolbar` module<br>Aligned components with the new theme system |
| 2 | https://github.com/MO-Movia/licit-plugin-contrib-multimedia | Changes done for Dark/Light Theme | Theme-aware toolbar icons<br>New SVG asset loader `images.ts`<br>Removed legacy icon-font CSS (resolved KNITE loader conflict) |
...
| 10 | https://github.com/MO-Movia/licit-plugin-contrib-vignette | Changes done for Dark/Light Theme | Theme-aware toolbar icons (`VignettePlugin.ts`)<br>Added `images.ts` loader |
| 11 | https://github.com/MO-Movia/lict-doc-attrs-step | Changes done for Tip-tap | `UICommand.ts`: exposed TipTap editor object globally to execute commands |
| 12 | https://github.com/MO-Movia/lict-toolbar | Separate module for Editor Toolbar | New standalone toolbar module<br>Major toolbar code extracted from `licit` and `ui-commands` |
| 13 | https://github.com/MO-Movia/MO-Movia-licit-plugin-contrib-table-mods | Changes done for Tip-tap | `Constants.ts`: updated table cell/row mapping to TipTap (`table_cell`, `table_row`) |
